...
- **13 páginas** HTML que navegan entre sí. ES: `index.html` (home), `blog.html`, `blog-post.html` (style guide universal), `pertinente.html`, `metase.html`, `podcasts.html` (directorio curado), `speaking.html`, `historia.html`. EN: `index.en.html`, `historia.en.html`, `speaking.en.html`, `blog.en.html`, `blog-post.en.html`.
- Header en las 13 páginas: **Blog · Podcasts · Speaking · Historia/Story** (sin "Lo último" ni "Tesis", que son anclas del home). Toggle de idioma ES/EN en el header.
...
- **`styles.css`** — estilos del home. **`pages.css`** — estilos de páginas internas (incluye speaking, blog-post template, brand ticker, chip-nav de podcasts).
- **`fonts/`** — Helvetica Neue (200–700 + itálicas) + Fraunces, self-hosted.
...
- **`README.md`** — documentación completa: tokens con valores, las secciones del home con medidas, las plantillas internas, interacciones, responsive.
