...
| `trabajar.html` | Detalle de servicios: Advisory + Speaking expandidos + banda CTA. |
| `historia.html` | Trayectoria completa como página propia (5 capítulos). |
...
### trabajar.html — Servicios (detalle)
- Banner claro + dos bloques (`.cr-svc__block`, grid 0.9/1.1): Advisory y Speaking, cada uno con eyebrow, título grande, body, y lista con sub-ítems (título + descripción) marcados con la **franja** en `::before`. CTA por bloque.
