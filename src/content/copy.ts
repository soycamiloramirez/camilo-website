  ...
  es: {
    ...
    contacto: {
      ...
      form: {
        ...
        successBody: 'Lo leo yo. Le respondo personalmente en los próximos días.',
        errorTitle: 'No pude enviar el mensaje.',
        errorBody: 'Intente de nuevo o escríbame directo a',
  ...
  en: {
    ...
    contacto: {
      ...
      form: {
        ...
        successBody: 'I read every request myself. I will reply personally in the coming days.',
        errorTitle: "Couldn't send your message.",
        errorBody: 'Try again or email me directly at',
